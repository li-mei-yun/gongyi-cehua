...
def main(top5_report, sql2):
    ...
    fields = [
        ...
        ("waiyuanzhijing1", "外圆直径1"),
        ("waiyuanzhijing2", "外圆直径2"),
        ("waiyuanzhijing3", "外圆直径3"),
        ("huajian_I_duan_zhongxinkong", "花键I端中心孔"),
        ("neiwailuowenduan_zhongxinkong", "内外螺纹端中心孔"),
        ("huajian_I_duan_zhongxinzuan_jianju", "花键I端中心钻检具"),
        ("neiwailuowenduan_zhongxinzuan_jianju", "内外螺纹端中心钻检具"),
    ]
